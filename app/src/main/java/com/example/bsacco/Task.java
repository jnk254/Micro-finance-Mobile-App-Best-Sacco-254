...
public class Task extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String [] services = new String[]{"Deposit","Withdrawal","Transfer Money","Borrow Loan","Payments","Savings"};
        ...
        ArrayAdapter adapter = new ArrayAdapter<>(this,android.R.layout.activity_list_item, android.R.id.text1, services);
         ...
         listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
             ...
             public void onItemClick(AdapterView<?> adapterView, View view, int service, long l) {
                if(service==0){
                    Intent intent = new Intent(Task.this,Deposit.class);
                    startActivity(intent);
                }
                if(service==1){
                    Intent intent = new Intent(Task.this,Withdrawal.class);
                    startActivity(intent);
                }
                if(service==2){
